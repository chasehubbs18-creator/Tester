...
function trialRoutineBegin(snapshot) {
  return async function () {
    ...
    trialComponents = [];
    trialComponents.push(Practice_image);
...
function trialRoutineEachFrame() {
  return async function () {
    ...
    if (Practice_image.status === PsychoJS.Status.STARTED){ // only update if being drawn
      Practice_image.setImage(Training_Pics, false);
    }
